...
// Info 1180: (298-369): Contract invariants and external call properties for :B:\n((x = 0) || (x = 1))\n
// Info 1180: (371-442): Contract invariants and external call properties for :C:\n((x = 0) || (x = 2))\n
// Info 1180: (444-522): Contract invariants and external call properties for :D:\n((x = 0) || (x = 3))\n
